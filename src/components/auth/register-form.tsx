    ...
    try {
      ...
      const { data, error: signUpError } = await supabase.auth.signUp({
        ...
        options: {
          ...
          emailRedirectTo: typeof window !== "undefined" ? `${window.location.origin}/auth/redirect` : undefined,
        },
      });
      ...
      if (data?.session) {
        ...
        // Confirmation email sent or requires login
        window.location.href = "/login?registered=verify_email";
      }
    } catch (err: any) {
