...
description: "Instruments telemetry, structured logging, distributed tracing, and metrics alerts. Trigger ONLY when adding monitoring, structured logs, or error-tracking infrastructure. Do NOT trigger for simple console.log debugging."
---
