...
description: "Profiles and optimizes slow queries, database indexes, N+1 patterns, bundle sizes, and Core Web Vitals. Trigger ONLY when diagnosing explicit latency bottlenecks or profiling performance. Do NOT trigger for routine algorithm implementation."
---
