...
description: "Executes production deployment checklists, smoke tests, and rollback strategies. Trigger ONLY when preparing a production release or go-live launch. Do NOT trigger for routine development milestones."
---
