---
name: design-flow
description: "Executes the multi-stage end-to-end design lifecycle (interview -> brief -> tokens -> build -> review). Trigger ONLY on explicit command to run full design flow. Do NOT trigger for individual ad-hoc frontend tasks."
---
