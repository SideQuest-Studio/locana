...
description: "Verifies library implementation details against official framework documentation. Trigger ONLY when resolving framework-specific ambiguity or integrating unfamiliar APIs. Do NOT trigger for familiar, standard language idioms."
---
