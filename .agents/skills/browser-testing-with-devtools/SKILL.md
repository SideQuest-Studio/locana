...
description: "Inspects live browser DOM, console errors, network requests, and performance via Chrome DevTools MCP. Trigger ONLY when interactive browser debugging or visual DOM inspection is required. Do NOT trigger for unit tests or static code analysis."
---
