...
description: "Performs deep multi-axis code review prior to merge. Trigger ONLY when explicitly requested to review a diff, PR, or completed implementation. Do NOT trigger during active coding turns."
---
