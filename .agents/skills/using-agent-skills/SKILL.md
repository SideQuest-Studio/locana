...
description: "Provides meta-guidance on skill discovery and invocation conventions. Trigger ONLY when an agent needs instruction on how skills operate. Do NOT trigger during standard domain tasks."
---
