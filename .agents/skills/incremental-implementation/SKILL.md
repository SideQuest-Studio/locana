...
description: "Guides safe multi-step code delivery across interrelated modules. Trigger ONLY when executing complex refactors across 4+ interdependent files. Do NOT trigger for routine multi-file edits or isolated bug fixes."
---
