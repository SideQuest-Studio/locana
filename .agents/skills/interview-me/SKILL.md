---
name: interview-me
description: "Extracts underlying user intent through one-at-a-time probing questions. Trigger ONLY when a user's initial project request is severely underspecified, or when explicitly requested via 'interview me'. Do NOT trigger when technical requirements are already provided."
---
