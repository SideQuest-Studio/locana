...
description: "Designs creative, production-grade visual UI concepts and component styling. Trigger ONLY when establishing visual direction, component aesthetic palettes, or bespoke styling. Do NOT trigger for standard state logic, bug fixes, or backend integration."
---
