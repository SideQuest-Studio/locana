---
name: design-brief
description: "Generates structured design brief markdown documents from user requirements. Trigger ONLY when drafting a formal UI/UX brief or design spec document. Do NOT trigger during active coding or component development."
---
