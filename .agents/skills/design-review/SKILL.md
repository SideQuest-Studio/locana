---
name: design-review
description: "Conducts design QA auditing visual hierarchy, responsiveness, and token consistency. Trigger ONLY when performing post-build UI critique or visual audit. Do NOT trigger during initial feature implementation."
---
