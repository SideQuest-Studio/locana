...
description: "Implements accessible (WCAG), responsive UI components and interactive layouts. Trigger ONLY when building complex interactive frontend components, forms, or accessibility trees. Do NOT trigger for visual branding ideation or pure backend logic."
---
