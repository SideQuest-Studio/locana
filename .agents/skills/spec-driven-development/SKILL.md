...
description: "Creates formal technical specifications and capability maps before coding. Trigger ONLY when initiating a new system/subsystem requiring a formal spec document. Do NOT trigger when an existing specification is already present."
---
