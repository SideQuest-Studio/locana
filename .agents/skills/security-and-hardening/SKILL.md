...
description: "Audits and hardens code against vulnerabilities (OWASP, RLS bypass, auth escalation, data privacy). Trigger ONLY when implementing security-sensitive endpoints, RLS policies, or addressing vulnerability reports. Do NOT trigger for general UI or non-sensitive logic."
---
