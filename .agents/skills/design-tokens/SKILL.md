---
name: design-tokens
description: "Generates semantic CSS variable or Tailwind token architectures (palettes, typography, spacing). Trigger ONLY when initializing a design system or modifying global tokens. Do NOT trigger for component-level styling or one-off CSS tweaks."
---
